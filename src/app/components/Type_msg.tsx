    ...
    <section className='type-msg-sec'>
        <div className='msg-wrapper'>
            <div className="emoji-img type-msg-imgs">
              <img src={Emoji.src} alt="emoji" className='cur-pointer' />
            </div>
            <div className='msg-type-input'>
                <input type="text" placeholder='type something...' className='input-fld' />
                <img src={sendMsg.src} alt="send message image" className='send-msg-icon cur-pointer' />
            </div>
            <div className='mic-image type-msg-imgs'>
                <img src={Mic.src} alt="mic image" className='cur-pointer' />
            </div>
        </div>
    </section>
  )
